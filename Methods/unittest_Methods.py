...
class SituationMethods_Test(unittest.TestCase):
    ...
    def test_PrecinctTableUnit(self):
        ...
        print(df2)
        df=pd.DataFrame({'201505':6.0,'201506':4.0},index=['101'])
        df=df.transpose()
    ...
    def test_BoroughTableUnit(self):
        ...
        print(df2)
        df=pd.DataFrame({'201505':557.0,'201506':635.0},index=['Queens'])
        df=df.transpose()
        self.assertTrue(df2.equals(df))
...
class ContributingMethods_Test(unittest.TestCase):
    ...
    def test_InfCalculate(self):
        ...
        self.assertEqual(df['AGGRESSIVE DRIVING/ROAD RAGE']['Number of Collisions'], 1)
    ...
    def test_BTHRInfTable_All(self):
        ...
        self.assertEqual(df['PassengKilled']['BICYCLE'], 2)
    ...
    def test_BoroughInfTable_Unit(self):
        ...
        self.assertEqual(df['PassengInjured']['BICYCLE'], 2)
    ...
    def test_CityInfTable_Unit(self):
        ...
        self.assertEqual(df['PersonsKilled']['BICYCLE'], 2)
    ...
    def test_boroughInfTable(self):
        ...
        self.assertEqual(df['AGGRESSIVE DRIVING/ROAD RAGE']['CyclistsKilled'], 0)
