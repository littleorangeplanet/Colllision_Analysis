...
# encoding: utf-8
'''
User_Interact.Interaction_Modules -- shortdesc

User_Interact.Interaction_Modules is a description
...
from struct_building import StructureBuilding
...
def ProgramIntroduction():
    ...
    print("Call for Help menu: Help")
    print("Now you start exploring. Enjoy!")
    print('>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>')

def BeginDate():
    '''
    Begin Date loading in 
    '''
    while True:
        try:
            print('The date is inclusive.\nTake note that the data is only available from January 2015.\nInput format: YYYYMM, Example: 201501')
            begintime=input('Please input a year and a month to begin:')
...
def EndDate():
    ...
    while True:
        try:
            ...
            endtime=input('Please input a year and a month to end:')
            GeneralCheck(endtime)
            OneDateCheck(endtime) 
            return endtime
        except InvalidDate:
            print("Invalid Date Input.")
...
def loadTimeInterval():
    '''
    Load whole collisions happened time according to the user command
    '''
    while True:
...
def CreateFolder(path):
    '''
    Create a folder according to the time interval to save all results figure
    '''
...
def SetTimeInterval(dirname):
    '''
    Set the time according to user.
    The project will be  loading and building a structure based on this time interval 
    '''
...
def Borough_Specific(NYC):
    '''
    Print all borough name and ask the user to choose one
    '''
...
def PrecinctbyBoroughPrint(NYC):
    '''
    Print all precinct name and ask the user to choose one
    '''
...
def Precinct_Specific(NYC):
    '''
    Print all precinct name in the borough and ask the user to choose one
    '''
...
def RoadNameDictPrint(NYC):
    '''
    Print all road name and ask the user to choose one
    '''
...
def Bridge_Specific(NYC):
    '''
    Print all bridge name and ask the user to choose one
    '''
    print('You can choose from:')
...
def Tunnel_Specific(NYC):
    '''
    Print all tunnel name and ask the user to choose one
    '''
    print('You can choose from:')
...
def Highway_Specific(NYC):
    '''
    Print all highway name and ask the user to choose one
    '''
    print('You can choose from:')
...
def Mainmenu(TimeBegin,TimeEnd,SavePath,NYC):
    '''
    Main menu of the entire project
    Args:
       TimeBegin:
       TimeEnd: 
       SavePath: result save path (string)
       NYC: city object
    Return:
    '''
    ...
    print("There are two types of information: \n 1-CollisionSituation \n 2-CollisionContributingFactors_Vehicle ")
    print('CollisionSituation: This contains brief summary and statistical analysis of collisions and the severity.')
    print('CollisionContributingFactors_Vehicle: This will show how did the contributing factors and vehicle types influence the collisions.')
...
def CollisionContributingFactors_Vehicle(NYC,SavePath,TimeBegin,TimeEnd):
    '''
    CollisionContributingFactors_Vehicle
    '''
